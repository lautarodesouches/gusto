...
export default function ReviewModal({ restaurant, isOpen, onClose }: ReviewModalProps) {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        // Enviar como número (double) - el backend espera double
        formData.append('valoracion', String(rating))
    ...
    return (
        <>
            ...
            <div className={modalStyles.modal}>
                <button className={modalStyles.closeButton} onClick={onClose} type="button" aria-label="Cerrar">
                ...
                <div className={modalStyles.modalContent}>
                    <div className={styles.reviewForm__container}>
                            ...
                            <div className={styles.reviewForm__card}>
                                <div className={styles.reviewForm__cardImage}>
                                    {restaurant.imagenUrl ? (
                                        ...
                                        <div className={styles.reviewForm__cardPlaceholder} />
                                    )}
                                </div>
                        ...
                        <form className={styles.reviewForm__form} onSubmit={handleSubmit}>
                            {/* Rating */}
                                    ...
                                    {VISIT_TYPES.map(type => (
                                        <button
                                            ...
                                            className={`${styles.reviewForm__button} ${
                                                visitType === type.id
                                                    ? styles['reviewForm__button--active']
                                                    : ''
                                            }`}
                                    ...
                                    <div className={styles.reviewForm__previews}>
                                        {imagePreviews.map((preview, index) => (
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    className={styles.reviewForm__removeImage}
